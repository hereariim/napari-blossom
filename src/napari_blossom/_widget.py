...
def do_image_segmentation(
    ...
    model_new = tf.keras.models.load_model(os.path.join(paths.get_models_dir(),"src\napari_blossom\best_model_FL_BCE_0_5.h5"),custom_objects={'dice_coefficient': dice_coefficient})
